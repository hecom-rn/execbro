    ...
    registerToolWithTelemetry(
        ...
        "network_replay",
        {
            description:
                ...
                "GOES THROUGH THE APP: same network stack, TLS trust, proxy and credentials as the original — so an active network_mock rule will intercept the replay too. The response says so when it does.\n" +
